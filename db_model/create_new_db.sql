...
-- -----------------------------------------------------
-- Table `rm_db`.`change_report`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `rm_db`.`change_report` ;

CREATE TABLE IF NOT EXISTS `rm_db`.`change_report` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `TEAM` VARCHAR(50) NOT NULL,
  `SPRINT` VARCHAR(45) NOT NULL,
  `CHANGE_ID` VARCHAR(45) NOT NULL,
  `CREATED_ON` DATE NOT NULL,
  `PATCHSETS_REWORK` INT NULL,
  `NUM_COMMENTS` INT NULL,
  `TIME_TO_MERGE` INT NOT NULL,
  `LOCK_DATE` DATE NOT NULL,
  `IS_DELIVERED_LATE` TINYINT(1) NOT NULL,
  PRIMARY KEY (`ID`))
ENGINE = InnoDB;
